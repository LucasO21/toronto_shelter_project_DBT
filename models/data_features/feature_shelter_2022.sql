-- this model preps the 2022 dataset for modeling
-- it uses the 'model_cohort_flag_2022' model to flag shelter locations that were open 75% or more days in 2022 and flags those as 1
...
with 
    cte_1 as (
        select 
            ...
            , t2.days_open_pct
            , t2.model_cohort    
        from {{ ref ('clean_shelter_2022') }} as t1
        left join {{ref ('model_cohort_flag_2022') }} as t2
        on t1.pkey = t2.pkey
